  ...
  implements MigrationInterface
{
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    const historicalMigrations = [
      {
        timestamp: 1710866600000,
        name: 'AddCategoryToRecurringTransaction1710866600000',
      },
      {
        timestamp: 1710892800000,
        name: 'AddExistingTransactionDataToPendingDuplicate1710892800000',
      },
      {
        timestamp: 1716123456789,
        name: 'IncreasedRecurringTransactionNameLength1716123456789',
      },
      ...
      { timestamp: 1735381000000, name: 'RemoveAutoSaveAmount1735381000000' },
      {
        ...
        name: 'AddSaltEdgeEnrichmentFields1735905600000',
      },
      {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DELETE FROM migrations WHERE timestamp < 1750000000003`,
    );
  }
}
