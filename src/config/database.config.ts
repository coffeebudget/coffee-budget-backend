...
export default registerAs('database', () => {
  ...
  if (databaseUrl && databaseUrl.includes('${{')) {
    ...
    console.log(
      'This should be automatically resolved by Railway, but it seems to not be working.',
    );
    ...
    if (actualDbUrl) {
      console.log(
        'Found actual database URL in alternative variable:',
        actualDbUrl,
      );
      databaseUrl = actualDbUrl;
    } else {
      console.log(
        'No alternative database URL found, will try individual variables',
      );
