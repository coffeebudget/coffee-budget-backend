...
export class BankAccountCreatedEvent extends BaseEventClass {
  constructor(public readonly bankAccount: BankAccount, userId: number) {
    super(userId);
  }
}
...
export class BankAccountDeletedEvent extends BaseEventClass {
  constructor(public readonly bankAccountId: number, userId: number) {
    super(userId);
  }
}

export class BankAccountTransactionsImportedEvent extends BaseEventClass {
  constructor(public readonly bankAccountId: number, public readonly importedCount: number, userId: number) {
    super(userId);
  }
}
